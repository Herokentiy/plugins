...
(function () {
	...
	var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
	var version_modss = '3.1', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = true, leftVipD = '', user_id = '', uid = 'bb04b81f6297b1b6280ea8273', IP = '37.110.36.79', logged = false;
  ...
  function collaps(component, _object) {
  	...
  	var embed = prox ? prox + 'https://api.topdbltj.ws/embed/' : 'https://api.insertunit.ws/embed/';
  	var select_title = '';
  	var filter_items = {};
  ...
  function Radio_n(object) {
  	...
  	this.create = function () {
  		var _this = this;
  		this.activity.loader(true);
  		if(object.url == '') object.url = API + 'r/record/';
